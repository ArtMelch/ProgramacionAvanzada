...
class Escuela:
    ...
    def __init__(self):
        coordinador = Coordinador(numero_control = "12345", nombre = "Edson", apellido = "Medina", contrasena = "123*", sueldo = 100000, rfc= "MEDINA123",anos_antig = 10)
    ...
    def validar_inicio_sesion(self, numero_control: str, constrasena: str):
        for usuario in self.lista_usuarios:
            if usuario.numero_control == numero_control:
                if usuario.contrasena == constrasena:
                    return usuario
